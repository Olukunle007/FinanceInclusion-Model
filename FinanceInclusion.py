...
st.markdown("<h3 style = 'margin: -25px; color: #FFC436; text-align: center;font-family: Arial, Helvetica, sans-serif; '>BY OLUKUNLE GODFIRST</h3>", unsafe_allow_html= True)
st.image('pngwing.com (4).png', width = 400)
